...
export let displayableContent: any = {
    0: [
        [
            ...
            JPJC School Colours Award - 2020
            `
        ], [
            LeagueMasteryImg,
    ...
    2: [
        [
            ...
            "7th PC Build",
            "August 2022",
            `With my PC building skills now, I had a friend who was into PC building as well and we got commissioned by acquaintances twice to build PCs. This was the second one for about $3000. As they didn't care about visuals, we decided to cramp a few budget oriented parts for better overall performance. The build was as such:
            \n
            ...
            "6th PC Build",
            "April 2022",
            `With my PC building skills now, I had a friend who was into PC building as well and we got commissioned by acquaintances twice to build PCs. This was the first one for about $3500. As they didn't care about visuals, we decided to cramp a few budget oriented and slightly questionable parts for better overall performance. The build was as such:
            \n
