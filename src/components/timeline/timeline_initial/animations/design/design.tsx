...
function TimelineDesignAnimation() {
    ...
    return(
        <div className="timelineDesignAnim" style={{scale: WHOLE_DESIGN_SCALE, transformOrigin: "0% 0%", transform: "translate(" + WHOLE_DESIGN_TRANSLATION[0] + ", " + WHOLE_DESIGN_TRANSLATION[1] + ")"}}>

            <div className="timelineDesignAnimContentWrapper">
                
                {/* Design Text itself */}

                <div className="timelineDesignAnimText flex-row">
                ...
                <div className="timelineDesignAnimContent2 flex-row">
                    ...
                    <div className="timelineDesignAnimContent2Col1 flex-col"> 
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="432px" ml="64px" mt="108px" br="10px" bgColour="rgb(35, 35, 35)" boxShadow="2px 2px 4px 2px rgba(60, 60, 60, 0.6)">

                            <div className="flex-row timelineDesignAnimCircle1">
                                <TimelineDesignAnimationBoxes width="64px" height="64px" ml="38px" mt="38px" bgColour={COLOUR_PALETTE[5]} br="50%" anim="0.6s col1box1Part1 ease 0s both, 0.6s col1box1Part2 ease 2.2s forwards" />
                                <TimelineDesignAnimationBoxes width="320px" height="38px" ml="154px" mt="13px" bgColour={COLOUR_PALETTE[3]} br="15px" anim="0.6s col1box2Part1 ease 0s both, 0.6s col1box2Part2 ease 2.2s forwards" />
                            </div>
    
                            <TimelineDesignAnimationBoxes width="100%" height="72px" ml="0" mt="500px" br="10px" bgColour={COLOUR_PALETTE[6]} anim="0.6s col1box3Part1 ease 0s both, 0.6s col1box3Part2 ease 2.2s forwards" />

                        </TimelineDesignAnimationBoxes>

                        {/* Multi Pictures looking card */}

                        <TimelineDesignAnimationBoxes width="512px" height="720px" ml="64px" mt="108px" br="10px" bgColour={COLOUR_PALETTE[6]} boxShadow="2px 2px 4px 2px rgba(60, 60, 60, 0.6)">

                            <TimelineDesignAnimationBoxes width="100%" height="612px" mt="108px" bgColour={COLOUR_PALETTE[1]} anim="1s col1box4Part1 ease 0s both, 1s col1box4Part2 ease 2.4s forwards"> 

                                <div className="flex-row">
                                    <TimelineDesignAnimationBoxes width="50%" height="144px" mt="43px" ml="8%" bgColour={COLOUR_PALETTE[3]} br="15px" anim="1s col1box5Part1 ease 0.3s both, 1s col1box5Part2 ease 2.1s forwards"/>
                                    <TimelineDesignAnimationBoxes width="25%" height="144px" mt="43px" ml="8%" bgColour={COLOUR_PALETTE[3]} br="15px" anim="1s col1box6Part1 ease 0.3s both, 1s col1box6Part2 ease 2.1s forwards"/>
                                </div>

                                <TimelineDesignAnimationBoxes width="80%" height="100px" mt="43px" ml="10%" bgColour={COLOUR_PALETTE[3]} br="15px" anim="1s col1box7Part1 ease 0.3s both, 1s col1box7Part2 ease 2.1s forwards"/>
                                <TimelineDesignAnimationBoxes width="30%" height="43px" mt="43px" ml="10%" bgColour={COLOUR_PALETTE[3]} br="15px" anim="1s col1box8Part1 ease 0.3s both, 1s col1box8Part2 ease 2.1s forwards"/>
                    ...
                    <div className="timelineDesignAnimContent2Col2 flex-col">
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="864px" ml="128px" mt="288px" br="10px" bgColour="rgb(35, 35, 35)" boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)"> 
        
                            <TimelineDesignAnimationBoxes id="2" width="100%" height="272px" ml="0" mt="0" br="10px" bgColour={COLOUR_PALETTE[0]} textAlign="center">
                            ...
                            <TimelineDesignAnimationBoxes width="216px" height="30px" ml="90px" mt="29px" br="20px" bgColour={COLOUR_PALETTE[5]} anim="0.9s col2box1Part1 ease 0s both, 0.75s col2box1Part2 ease 2.6s forwards" />
                            <TimelineDesignAnimationBoxes width="209px" height="216px" ml="102px" mt="36px" br="20px" bgColour={COLOUR_PALETTE[2]} anim="0.9s col2box2Part1 ease 0.2s both, 0.8s col2box2Part2 ease 2.4s forwards" />
                            <TimelineDesignAnimationBoxes width="216px" height="20px" ml="90px" mt="36px" br="20px" bgColour={COLOUR_PALETTE[3]} anim="0.8s col2box1Part1 ease 0.6s both, 0.8s col2box1Part2 ease 2.2s forwards" />
                            <TimelineDesignAnimationBoxes width="187px" height="20px" ml="141px" mt="22px" br="20px" bgColour={COLOUR_PALETTE[5]} anim="0.8s col2box4Part1 ease 1s both, 0.8s col2box4Part2 ease 2s forwards" />
                    ...
                    <div className="timelineDesignAnimContent2Col3 flex-col">
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="576px" ml="102px" mt="-216px" br="10px" bgColour={COLOUR_PALETTE[0]} boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">

                            <div className="pieChart" style={{"scale": "1", "transformOrigin": "centre"}}></div>

                            <div className="pageDots flex-row flex-jc-space-a">
                                <TimelineDesignAnimationBoxes br="50%" height="14px" width="auto" ar="1" ml="35%" mt="43px" bgColour={COLOUR_PALETTE[2]} anim="0.5s fadeIn ease 0s both, 0.5s fadeOut ease 1.8s forwards" />
                                <TimelineDesignAnimationBoxes br="50%" height="14px" width="auto" ar="1" mt="43px" bgColour={COLOUR_PALETTE[4]} anim="0.5s fadeIn ease 0.2s both, 0.5s fadeOut ease 2.0s forwards" />
                                <TimelineDesignAnimationBoxes br="50%" height="14px" width="auto" ar="1" mr="35%" mt="43px" bgColour={COLOUR_PALETTE[2]} anim="0.5s fadeIn ease 0.4s both, 0.5s fadeOut ease 2.2s forwards" />
                            </div>

                            <TimelineDesignAnimationBoxes br="15px" height="43px" width="80%" ml="10%" mt="43px" bgColour={COLOUR_PALETTE[2]} anim="0.8s col3box1Part1 ease 0s both, 0.8s col3box1Part2 ease 2.0s forwards" />

                        </TimelineDesignAnimationBoxes>

                        {/* Wave card */}

                        <TimelineDesignAnimationBoxes width="512px" height="432px" ml="102px" mt="72px" overflow="hidden" br="15px" boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">
                            <div className="timelineDesignAnimContent2col3row2BG" style={{overflow: "hidden", transformOrigin: "0 0", scale: "2"}}>
                                <svg viewBox="0 0 900 600" width="900" height="600" xmlns="http://www.w3.org/2000/svg" style={{scale: "0.4", transformOrigin: "0 0"}}>
                                    <rect x="0" y="0" width="900" height="600" fill={COLOUR_PALETTE[0]}></rect>
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="576px" ml="102px" mt="72px" br="20px" bgColour={COLOUR_PALETTE[0]} overflow="hidden" boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">

                            <div style={{overflow: "hidden", transformOrigin: "0 0", scale: "2"}}>
                    ...
                    <div className="timelineDesignAnimContent2Col4 flex-col">
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="576px" ml="64px" mt="-144px" br="10px" bgColour={COLOUR_PALETTE[0]} boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">

                            <div className="pageDots" style={{marginTop: "108px"}}>

                                <div className="lineGraphSVG text-c" style={{scale: "1"}}>
                                    <svg width="192" height="100" viewBox="0 0 192 100" fill="none" xmlns="http://www.w3.org/2000/svg" style={{scale: "1.5"}}>
                                        <path d="M9 45L37 79L60 7L75 54L109 94L136 60L171 42" stroke={COLOUR_PALETTE[4]} stroke-width="4" stroke-linejoin="round" style={{animation: "2.5s lineGraph cubic-bezier(.5, 0, .5, 1) 0s both, 1s fadeIn cubic-bezier(.5, 0, .5, 1), 0.5s fadeOut cubic-bezier(.5, 0, .5, 1) 3.5s forwards"}}/>
                                        <circle cx="9" cy="45" r="6" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease 0s both, 0.5s fadeOut ease 1.4s forwards"}}/>
                                        <circle cx="37" cy="79" r="6" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease 0.2s both, 0.5s fadeOut ease 1.55s forwards"}}/>
                                        <circle cx="60" cy="7" r="7" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease 0.35s both, 0.75s fadeOut ease 1.8s forwards"}}/>
                                        <circle cx="75" cy="54" r="5" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease 0.45s both, 0.75s fadeOut ease 1.85s forwards"}}/>
                                        <circle cx="109" cy="94" r="6" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease 0.5s both, 0.5s fadeOut ease 1.875s forwards"}}/>
                                        <circle cx="136" cy="60" r="4" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease .625s both, 0.5s fadeOut ease 2s forwards"}}/>
                                        <circle cx="171" cy="42" r="6" fill={COLOUR_PALETTE[5]} style={{animation: "0.5s fadeIn ease 0.825s both, 0.4s fadeOut ease 2.25s forwards"}}/>
                                    </svg>
                                </div>

                                <TimelineDesignAnimationBoxes br="15px" height="43px" width="60%" ml="20%" mt="108px" bgColour={COLOUR_PALETTE[2]} anim="0.8s col4box1Part1 ease 0.2s both, 0.8s col4box1Part2 ease 2s forwards" />
                                <TimelineDesignAnimationBoxes br="15px" height="22px" width="30%" ml="35%" mt="29px" bgColour={COLOUR_PALETTE[2]} anim="0.8s col4box2Part1 ease 0.5s both, 0.8s col4box2Part2 ease 1.7s forwards" />
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="432px" ml="64px" mt="72px" br="10px" bgColour={COLOUR_PALETTE[0]} boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">

                            <div className="cubeWrapper" style={{marginTop: "108px"}}>
            ...
            <div className="timelineDesignAnimCorners absolutePos">
                ...
                {/* Top left */}
                <TimelineDesignAnimationBoxes height="2000px" width="45px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="2.75s cornerDesignTopLeft1 linear both" />
                <TimelineDesignAnimationBoxes height="1000px" width="25px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="3s cornerDesignTopLeft2 linear both 0.2s" />
                <TimelineDesignAnimationBoxes height="200px" width="20px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="2.8s cornerDesignTopLeft3 linear both 0.4s" />
                <TimelineDesignAnimationBoxes height="30px" width="200px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="3s cornerDesignTopLeft4 linear both" transform="translate(0px, -50px)" />
                <TimelineDesignAnimationBoxes height="10px" width="200px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="2.8s cornerDesignTopLeft5 linear both" transform="translate(0px, -10px)" />

                {/* Top Right */}
                <TimelineDesignAnimationBoxes height="10px" width="200px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="2.4s cornerDesignTopRight1 linear both 0.2s" transform="translate(0px, -10px)" />
                <TimelineDesignAnimationBoxes height="30px" width="200px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="2.8s cornerDesignTopRight2 linear both" transform="translate(0px, -10px)" />

                {/* Bottom Right */}
                <TimelineDesignAnimationBoxes height="30px" width="200px" rotate="5deg" bgColour={COLOUR_PALETTE[5]} br="25px" pos="absolute" transformOrigin="0% 0%" anim="2.7s cornerDesignBottomRight1 linear both 0.2s" transform="translate(0px, -10px)" />
