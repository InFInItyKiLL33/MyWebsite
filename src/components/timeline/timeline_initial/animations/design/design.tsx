...
function TimelineDesignAnimation() {
    ...
    const wholeDesignScale = (window.innerWidth / window.innerHeight < 16 / 9) ? String((window.innerHeight) / (1440)) : String((window.innerWidth) / (2560));
    const wholeDesignTranslate = [
    ...
    return(
        <div className="timelineDesignAnim" style={{scale: wholeDesignScale, transformOrigin: "0% 0%", transform: "translate(" + wholeDesignTranslate[0] + ", " + wholeDesignTranslate[1] + ")"}}>
                ...
                <div className="timelineDesignAnimContent2 flex-row">
                    ...
                    <div className="timelineDesignAnimContent2Col1 flex-col"> 
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="432px" ml="64px" mt="108px" br="10px" bgColour="rgb(35, 35, 35)" boxShadow="2px 2px 4px 2px rgba(60, 60, 60, 0.6)">
                            ...
                            <div className="flex-row timelineDesignAnimCircle1">
                                <TimelineDesignAnimationBoxes width="64px" height="64px" ml="38px" mt="38px" bgColour={colourPalette[5]} br="50%" anim="0.6s col1box1Part1 ease 0s both, 0.6s col1box1Part2 ease 2.2s forwards" />
                                <TimelineDesignAnimationBoxes width="320px" height="38px" ml="154px" mt="13px" bgColour={colourPalette[3]} br="15px" anim="0.6s col1box2Part1 ease 0s both, 0.6s col1box2Part2 ease 2.2s forwards" />
                            </div>
    
                            <TimelineDesignAnimationBoxes width="100%" height="72px" ml="0" mt="500px" br="10px" bgColour={colourPalette[6]} anim="0.6s col1box3Part1 ease 0s both, 0.6s col1box3Part2 ease 2.2s forwards" />

                        </TimelineDesignAnimationBoxes>

                        {/* Multi Pictures looking card */}

                        <TimelineDesignAnimationBoxes width="512px" height="720px" ml="64px" mt="108px" br="10px" bgColour={colourPalette[6]} boxShadow="2px 2px 4px 2px rgba(60, 60, 60, 0.6)">

                            <TimelineDesignAnimationBoxes width="100%" height="612px" mt="108px" bgColour={colourPalette[1]} anim="1s col1box4Part1 ease 0s both, 1s col1box4Part2 ease 2.4s forwards"> 

                                <div className="flex-row">
                                    <TimelineDesignAnimationBoxes width="50%" height="144px" mt="43px" ml="8%" bgColour={colourPalette[3]} br="15px" anim="1s col1box5Part1 ease 0.3s both, 1s col1box5Part2 ease 2.1s forwards"/>
                                    <TimelineDesignAnimationBoxes width="25%" height="144px" mt="43px" ml="8%" bgColour={colourPalette[3]} br="15px" anim="1s col1box6Part1 ease 0.3s both, 1s col1box6Part2 ease 2.1s forwards"/>
                                </div>

                                <TimelineDesignAnimationBoxes width="80%" height="100px" mt="43px" ml="10%" bgColour={colourPalette[3]} br="15px" anim="1s col1box7Part1 ease 0.3s both, 1s col1box7Part2 ease 2.1s forwards"/>
                                <TimelineDesignAnimationBoxes width="30%" height="43px" mt="43px" ml="10%" bgColour={colourPalette[3]} br="15px" anim="1s col1box8Part1 ease 0.3s both, 1s col1box8Part2 ease 2.1s forwards"/>
                    ...
                    <div className="timelineDesignAnimContent2Col2 flex-col">
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="864px" ml="128px" mt="288px" br="10px" bgColour="rgb(35, 35, 35)" boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)"> 
                            ...
                            <TimelineDesignAnimationBoxes id="2" width="100%" height="272px" ml="0" mt="0" br="10px" bgColour={colourPalette[0]} textAlign="center">
                            ...
                            <TimelineDesignAnimationBoxes width="216px" height="30px" ml="90px" mt="29px" br="20px" bgColour={colourPalette[5]} anim="0.9s col2box1Part1 ease 0s both, 0.75s col2box1Part2 ease 2.6s forwards" />
                            <TimelineDesignAnimationBoxes width="209px" height="216px" ml="102px" mt="36px" br="20px" bgColour={colourPalette[2]} anim="0.9s col2box2Part1 ease 0.2s both, 0.8s col2box2Part2 ease 2.4s forwards" />
                            <TimelineDesignAnimationBoxes width="216px" height="20px" ml="90px" mt="36px" br="20px" bgColour={colourPalette[3]} anim="0.8s col2box1Part1 ease 0.6s both, 0.8s col2box1Part2 ease 2.2s forwards" />
                            <TimelineDesignAnimationBoxes width="187px" height="20px" ml="141px" mt="22px" br="20px" bgColour={colourPalette[5]} anim="0.8s col2box4Part1 ease 1s both, 0.8s col2box4Part2 ease 2s forwards" />
                    ...
                    <div className="timelineDesignAnimContent2Col3 flex-col">
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="576px" ml="102px" mt="-216px" br="10px" bgColour={colourPalette[0]} boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">

                            <div className="pieChart" style={{"scale": "1", "transformOrigin": "centre"}}></div>

                            <div className="pageDots flex-row flex-jc-space-a">
                                <TimelineDesignAnimationBoxes br="50%" height="14px" width="auto" ar="1" ml="35%" mt="43px" bgColour={colourPalette[2]} anim="0.5s fadeIn ease 0s both, 0.5s fadeOut ease 1.8s forwards" />
                                <TimelineDesignAnimationBoxes br="50%" height="14px" width="auto" ar="1" mt="43px" bgColour={colourPalette[4]} anim="0.5s fadeIn ease 0.2s both, 0.5s fadeOut ease 2.0s forwards" />
                                <TimelineDesignAnimationBoxes br="50%" height="14px" width="auto" ar="1" mr="35%" mt="43px" bgColour={colourPalette[2]} anim="0.5s fadeIn ease 0.4s both, 0.5s fadeOut ease 2.2s forwards" />
                            </div>

                            <TimelineDesignAnimationBoxes br="15px" height="43px" width="80%" ml="10%" mt="43px" bgColour={colourPalette[2]} anim="0.8s col3box1Part1 ease 0s both, 0.8s col3box1Part2 ease 2.0s forwards" />
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="576px" ml="102px" mt="72px" br="20px" bgColour={colourPalette[0]} overflow="hidden" boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">
                    ...
                    <div className="timelineDesignAnimContent2Col4 flex-col">
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="576px" ml="64px" mt="-144px" br="10px" bgColour={colourPalette[0]} boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">
                            ...
                            <div className="pageDots" style={{marginTop: "108px"}}>
                                ...
                                <TimelineDesignAnimationBoxes br="15px" height="43px" width="60%" ml="20%" mt="108px" bgColour={colourPalette[2]} anim="0.8s col4box1Part1 ease 0.2s both, 0.8s col4box1Part2 ease 2s forwards" />
                                <TimelineDesignAnimationBoxes br="15px" height="22px" width="30%" ml="35%" mt="29px" bgColour={colourPalette[2]} anim="0.8s col4box2Part1 ease 0.5s both, 0.8s col4box2Part2 ease 1.7s forwards" />
                        ...
                        <TimelineDesignAnimationBoxes width="512px" height="432px" ml="64px" mt="72px" br="10px" bgColour={colourPalette[0]} boxShadow="4px 4px 4px 2px rgba(60, 60, 60, 0.6)">
