    ...
    return(
        <div className="contact">
            ...
            <div className="contactInfo flex-row flex-jc-space-e">
                ...
                <div className="contactInfoEach flex-row" onMouseUp={() => {window.open("https://t.me/InfinityTwo", '_blank')}}>
                ...
                <div className="contactInfoEach flex-row" onMouseUp={() => {window.open("mailto:2poh.junkang@gmail.com", '_blank')}}>
                ...
                <div className="contactInfoEach flex-row" onMouseUp={() => {window.open("https://github.com/InFInItyKiLL33", '_blank')}}>
