    ...
    return(
        <div className="contact">
            ...
            <div className="contactInfo flex-row flex-jc-space-e">
                ...
                <div className="contactInfoEach contactInfoEach1 flex-row" onMouseUp={() => {window.open("https://t.me/InfinityTwo", '_blank')}}>
                ...
                <div className="contactInfoEach contactInfoEach2 flex-row" onMouseUp={() => {window.open("mailto:2poh.junkang@gmail.com", '_blank')}}>
                ...
                <div className="contactInfoEach contactInfoEach3 flex-row" onMouseUp={() => {window.open("https://github.com/InFInItyKiLL33", '_blank')}}>
                    ...
                    <div className="flex-col contactInfoTextWrapper">
                        ...
                        <p className="contactLinks contactLinksGithub">github.com/InFInItyKiLL33</p>
                    </div>
                </div>
